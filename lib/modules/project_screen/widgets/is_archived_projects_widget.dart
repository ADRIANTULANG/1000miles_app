...
class IsArchivedProjects extends GetView<ProjectsScreenController> {
  const IsArchivedProjects({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Obx(
        () => controller.isArchivedProjectList.length == 0
            ? Container(
            ...
            : Column(
                children: [
                  Expanded(
                    child: Obx(
                      () => ListView.builder(
                        controller: controller.scrollController_is_archived,
                        itemCount: controller.isArchivedProjectList.length,
                              ...
                              onTap: () {
                                Get.to(() => ProjectSpaceView(), arguments: {
                                  'projectName': controller
                                      .isArchivedProjectList[index].name!,
                                  'projectID': controller
                                      .isArchivedProjectList[index].id!
                                      .toString()
                                });
                              },
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    controller.isArchivedProjectList[index]
                                                    .file!.file ==
                                                null ||
                                            controller
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            InkWell(
                                                              onTap: () {
                                                                Get.back();
                                                                controller.un_archivedProjects(
                                                                    projectID: controller
                                                                        .isArchivedProjectList[
                                                                            index]
                                                                        .id!);
