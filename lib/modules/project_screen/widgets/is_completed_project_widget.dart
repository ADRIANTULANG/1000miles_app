...
class IsCompletedProjects extends GetView<ProjectsScreenController> {
  const IsCompletedProjects({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Obx(
        () => controller.isCompletedProjectList.length == 0
            ? Container(
            ...
            : Column(
                children: [
                  Expanded(
                    child: Obx(
                      () => ListView.builder(
                        controller: controller.scrollController_is_completed,
                        itemCount: controller.isCompletedProjectList.length,
                              ...
                              onTap: () {
                                Get.to(() => ProjectSpaceView(), arguments: {
                                  'projectName': controller
                                      .isCompletedProjectList[index].name!,
                                  'projectID': controller
                                      .isCompletedProjectList[index].id!
                                      .toString()
                                });
                              },
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    controller.isCompletedProjectList[index]
                                                    .file!.file ==
                                                null ||
                                            controller
