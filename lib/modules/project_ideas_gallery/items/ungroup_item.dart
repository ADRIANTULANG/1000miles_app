...
class UngroupedItem extends GetView<ProjectIdeasGalleryController> {
  const UngroupedItem(
      {required this.image,
      required this.index,
      required this.name,
    ...
    return InkWell(
      onTap: () {
        if (controller.isEditing_for_homescreen.value == true &&
          ...
          if (controller.ungrouped_list[index].isSelected.value == false) {
            controller.ungrouped_list[index].isSelected.value = true;
          } else {
            controller.ungrouped_list[index].isSelected.value = false;
          }
        } else {
                  ...
                  () => controller.isEditing_for_homescreen.value == true &&
                      ...
                      ? Positioned(
                          ...
                          child: InkWell(
                            onTap: () {
                              if (controller
                                      .ungrouped_list[index].isSelected.value ==
                                  false) {
                                controller.ungrouped_list[index].isSelected
                                    .value = true;
                              } else {
                                controller.ungrouped_list[index].isSelected
                                    .value = false;
